...
Onemogućavanje pojačavanja na jednom od pojačanih linkova
...
Dugme za brisanje kontakta zasnovano na htmx-u
...
Ažurirani obrađivač sa 303 odgovorom preusmeravanja
...
To znači da, pošto će preusmeravanje na "/contacts" URL ponovo prikazati celu listu kontakata, završićemo sa tom listom kontakata smeštenom unutar dugmeta "Izbriši kontakt".
...
Sada, kada neko klikne na dugme "Izbriši kontakt", biće mu prikazan upit sa pitanjem "Da li ste sigurni da želite da izbrišete ovaj kontakt?" i imaće priliku da otkaže ako je greškom kliknuo na dugme. Veoma lepo.
...
Kao što smo ranije napomenuli u vezi sa ovim rešenjem: ono nije progresivno poboljšanje naše veb aplikacije. Ako je neko onemogućio JavaScript, onda ovo dugme "Izbriši kontakt" više neće raditi. Morali bismo da obavimo dodatni posao kako bismo održali funkciju starijeg mehanizma zasnovanog na obrascima u okruženju sa onemogućenim JavaScript-om.
...
> [!Note] Server-Side vs. Client-Side Validations  
>
...
---
> [!Note] Relativni pozicioni izrazi u htmx  
>
...
Pokretanje sa `keyup` događajima
...
Ispostavlja se da možemo prenameniti kod "Klikni za učitavanje" da bismo prilično lako implementirali ovaj novi obrazac: ako razmislite o tome na trenutak, beskonačno skrolovanje je zapravo samo logika "Klikni za učitavanje", ali umesto učitavanja kada se dogodi događaj klika, želimo da učitamo kada se element "otkrije" u portalu pregledača.
...
Sve što je trebalo da uradimo da bismo konvertovali iz "Klikni za učitavanje" u "Beskonačno skrolovanje" jeste da ažuriramo naš element da bude raspon, a zatim dodamo revealedokidač događaja.

Činjenica da je prelazak na beskonačno skrolovanje bio tako lak pokazuje koliko dobro htmx generalizuje HTML: samo nekoliko atributa nam omogućava da dramatično proširimo ono što možemo postići u hipermediji.
...
> [!Info] HTML napomene  
> **Oprez sa modalnim prozorima i "display: none"**
>
