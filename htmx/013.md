...
rows.xmlšablonom za interakcije kao što su pretraživanje, Infinity scrolling i povlačenje za osvežavanje.
...
"Infinity scrolling". Aplikacija učitava fiksni broj početnih stavki na listi, recimo 100 stavki. Ako korisnik
...
rotirajući alat i aplikacija će učitati sledeći skup sadržaja. Infinity scrolling poboljšava performanse
...
Do sada smo videli triggervrednosti changei refresh. Ali da bismo implementirali Infinity scrolling,
...
HXML za dugme "Delete" je prilično sličan dugmetu "Sačuvaj", ali postoji nekoliko suptilnih razlika. Zapamtite,
...
1. Pritiskom na dugme "Delete" pokreće se radnja za prikazivanje sistemskog dijaloga sa datim naslovom i
porukom.
