...
### 2.2 Hipermedijske kontrole

Hipermedijske kontrole su ono što razlikuje hipermediju od drugih vrsta medija.

Možda vam je termin hipertekst poznatiji, hipertekst je podkategorija hipermedije i veliki deo ove knjige će razmatrati kako da se naprave moderne aplikacije koristeći hipertekste kao što su HTML, jezik za označavanje hiperteksta ili HXML, hipertekst koji koristi mobilni hipermedijalni sistem Hyperview.
...
### 2.4 Najuspešniji hipertekst na svetu - HTML
...
Kod 2.4.1.1 - Jednostavna hiperlink veza
...
#### 2.5.1 Aplikacije za jednu stranicu
...
### 2.6 Zašto koristiti hipermediju
...
#### 2.6.3 Javaskript biblioteke orijentisane na hipermediju
...
### 2.7 Aplikacije vođene hipermedijom
...
#### 2.7.1 Šta je aplikacija vođena hipermedijom (HDA)
...
Kod 2.7.1.1 - Implementacija htmx-a
...
#### 2.7.2 Kada bi trebalo koristiti hipemediju
...
#### 2.7.3 Kada ne bi trebalo koristiti hipemediju
...
### 2.8 Hipermedija: sofisticirana, moderna arhitektura sistema
...
> ```
>
> Kod 2.8.1 - Dodavanje onclick listenera div elementu
>
...
> ```
>
> Kod 2.8.2 - Popravka prethodne definicije dugmeta
>
...
Kod 3.1.2.1 - HTTP Zahtev klijenta
...
Kod 3..1.2.2 - HTTP Odgovor servera
...
Kod 3.2.1.1 - HTML reprezentacija
...
Kod 3.2.1.2 - JSON reprezentacija
...
Kod 3.2.1.3 - HTML reprezentacija
...
Kod 3.2.1.4 - JSO reprezentacija
...
Kod 3.2.1.5 - HTML reprezentacija
...
Kod 3.2.1.6 - JSON Reprezentacija
...
Kod 4.1.1 - Jednostavna ruta "Zdravo svete"
...
Kod 4.1.2 - Promena "Zdravo svete" u preusmeravanje
...
Kod 4.2.1 - Rukovalac za pretragu na strani servera
...
Kod 4.2.2.1 - Početak datoteke index.html
...
Kod 4.2.3.1 - GET ruta za "novi kontakt"
...
Kod 4.2.3.2 - Forma "Novi kontakt"
...
Kod 4.2.3.3 - Unosi i oznake za obrazac "Novi kontakt"
...
Kod 4.2.3.4 - Dugme za slanje za obrazac "Novi kontakt"
...
Kod 4.2.4.1 - Kod kontrolera "novog kontakta"
...
Kod 4.2.5.1 - Kontroler u Pajtonu
...
Kod 4.2.6.1 - Šablon "Kontakt podaci"
...
Kod 4.2.7.1 - Kod kontrolera za "uređivanje kontakta"
...
Kod 4.2.7.2 - Početak obrasca za "Uređivanje kontakta"
...
Kod 4.2.7.3 - Telo obrasca za "Uređivanje kontakta"
...
Kod 4.2.7.4 - Podnožje obrasca za "Uređivanje kontakta"
...
Kod 4.9.1 - Kod kontrolera za "brisanje kontakta"
