...
Kod 5.2 - Instaliranje htmx-a sa CDN-a
...
Kod 5.3 - Jednostavno dugme zasnovano na htmx-u
...
Kod 5.4 - Delimični HTML odgovor na htmlx zahtev
...
Kod 5.5 - Jednostavno dugme zasnovano na htmx-u
...
Kod 5.7 - Naš HTML nakon završetka htmx zahteva
...
Kod 5.8 - (Loše dizajnirano) dugme koje se aktivira pri `mouseenter` događaju
...
Kod 5.9 - Početak, okidač pritiskom na taster
...
Kod 5.10 - Poboljšanje sa filterom pri otkucavanju tastera
...
Kod 5.11 - Još bolje, slušajte otkucaje tastature na body
...
Kod 5.12 - Dugme za pretragu zasnovano na htmx-u
...
Kod 5.13 - Dugme za pretragu zasnovano na htmx-u sa `hx-include`
...
Kod 5.14 - Dugme koje koristi htmx tehnologiju sa `hx-vals`.
