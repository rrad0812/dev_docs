...
- [01 How to text search by completly phrase?][01]
- [02 How to find detail record?][02]
- [03 How to create a edit form without access to a view form?][03]
- [04 How to expose Jam.py as as web services?][04]
- [05 How to access edit form when access rigth is on view form only?][05]
- [06 How to hide some menu options from general users, and unhide the same for other?][06]
- [07 Are users transferred when using app import and export functions?][07]
- [08 How to do with Stored Procedure?][08]
- [09 How to create dependent drop-down lists?][09]
- [10 How to do with barcode?][10]
- [11 How to do with the detail item?][11]
- [12 How to create a text area control as part of catalog?][12]
- [13 How to change the item_type of the catalog to detail_item?][13]
- [14 How to do with batches process?][14]
- [15 How to do with asynchronous/synchronous request to server?][15]
- [16 How to do with details?][16]
- [17 How to do a multiselect filter in user interface or OR filter?][17]
- [18 How to do with conversion ods document?][18]
- [19 How to do with strong validation?][19]
- [20 How to automated Jam.py export?][20]
- [21 How to enable users to change their password?][21]
- [22 How to integrate help tab?][22]
- [23 How to do with virtual tables?][23]
- [24 How to create a static home page in jam.py?][24]
- [25 How to do with strong validation II?][25]
- [26 How to do with registreted form?][26]
...
If you have some external database you can create an `virtual_table` item with the same fields as in this database table and the same table name, and then write the `on_open` event handler in the server module (for sqlite db):
...
def on_open(item, params): 
  ...
  try: 
    connection = sqlite3.connect(db_path) // path to sqlite db 
...
[01]: #how-to-text-search-by-completly-phrase
[02]: #how-to-find-detail-record
[03]: #how-to-create-a-edit-form-without-access-to-a-view-form
[04]: #how-to-expose-jampy-as-as-web-services
[05]: #how-to-access-edit-form-when-access-right-is-on-view-form-only
[06]: #how-to-hide-some-menu-options-from-general-users-and-unhide-the-same-for-other
[07]: #are-users-transferred-when-using-app-import-and-export-functions
[08]: #how-to-do-with-stored-procedure
[09]: #how-to-create-dependent-drop-down-lists
[10]: #how-to-do-with-barcode
[11]: #how-to-do-with-the-detail-item
[12]: #how-to-create-a-text-area-control-as-part-of-catalog
[13]: #how-to-change-the-item_type-of-the-catalog-to-detail_item
[14]: #how-to-do-with-batches-process
[15]: #how-to-do-with-asynchronoussynchronous-request-to-server
[16]: #how-to-do-with-details
[17]: #how-to-do-a-multiselect-filter-in-user-interface-or-or-filter
[18]: #how-to-do-with-conversion-ods-document
[19]: #how-to-do-with-strong-validation
[20]: #how-to-automated-jampy-export
[21]: #how-to-enable-users-to-change-their-password
[22]: #how-to-integrate-help-tab
[23]: #how-to-do-with-virtual-tables
[24]: #how-to-create-a-static-home-page-in-jampy
[25]: #how-to-do-with-strong-validation-ii
[26]: #how-to-do-with-registreted-form
