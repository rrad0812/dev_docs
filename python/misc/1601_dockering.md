...
- **Česta zabuna**  
  ...
  Nije isto.
  - `docker build` ignoriše `docker-compose.yml`. On uzima Dockerfile, gradi
    image i završava.
  - `docker compose build` koristi sekciju `build:` iz compose fajla, zna ime
    servisa, tag, args, context, sve.
