...
Nakon što izvršimo gorji kod, server počije da sluša port 9090 na lokalnom hostu.
...
Ako radite sa Pajtonom, trebalo bi da znate šta je Tornado, a gorji primer je veoma sličan tome.
...
Zahtev: zahtevanje podataka od korisnika, uključujući POST, GET, kolačić i URL.

Odgovor: podaci odgovora od servera ka klijentima.

Kon: veze između klijenata i servera.

Rukovalac: Logika obrade zahteva i generisanje odgovora.
