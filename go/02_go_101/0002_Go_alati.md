...
- Reči **package** i **func** su ključne reči. Dve **main** reči su dva identifikatora. Ključne reči i identifikatori su predstavljeni u narednom članku.

- Prvi red **package main** navodi ime paketa ( main ovde) koji sadrži izvornu datoteku.
...
Ništa se ne prikazuje? Da, ovaj program ne prikazuje ništa.

Ako postoje neke sintaksičke greške u izvornom kodu, onda će te greške biti prijavljene kao greške pri kompajlaciji.
